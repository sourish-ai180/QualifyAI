        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/builder" className="text-gray-400 hover:text-white text-sm transition-colors">AI Builder</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/documentation" className="text-gray-400 hover:text-white text-sm transition-colors">Sales Scripts</Link></li>
              <li><Link to="/documentation" className="text-gray-400 hover:text-white text-sm transition-colors">API Reference</Link></li>
              <li><Link to="/documentation" className="text-gray-400 hover:text-white text-sm transition-colors">Support</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/privacy" className="text-gray-400 hover:text-white text-sm transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
