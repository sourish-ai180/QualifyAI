...
import { Send, Zap, Calendar, ArrowRight, RefreshCcw, User } from 'lucide-react';
...
const ChatClient: React.FC = () => {
    ...
    const { qualifier, loading } = useQualifier(qualifierId || undefined);
        ...
        return (
            <div className="fixed inset-0 bg-dark-950 flex items-center justify-center p-6 text-center">
                <div className="max-w-md">
                    ...
                    <p className="text-gray-400">This link might be invalid or expired: {qualifierId}</p>
                    <p className="text-xs text-gray-500 mt-4">Debug: Ensure your URL looks like .../chat?id=YOUR_ID</p>
                </div>
            </div>
        );
    }
